...
@SpringBootTest(webEnvironment=RANDOM_PORT, properties = ***REMOVED***
        "spring.datasource.url=jdbc:h2:mem:review-db"***REMOVED***)
...
***REMOVED***
    ...
    private WebTestClient.BodyContentSpec getAndVerifyReviewsByProductId(int productId,
                                                                         HttpStatus expectedStatus) ***REMOVED***
...
***REMOVED***
    ...
    private void deleteAndVerifyReviewsByProductId(int productId, HttpStatus expectedStatus) ***REMOVED***
         client.delete()
