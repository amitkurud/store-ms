...
public interface ProductServiceApi extends ProductService ***REMOVED***
     ...
     */
    @Override
    @GetMapping(value = "***REMOVED***productId***REMOVED***",
     ...
     * '***REMOVED***"productId":123,"name":"product 123","weight":123***REMOVED***'</p>
     *
     ...
     */
    @Override
    @DeleteMapping("***REMOVED***productId***REMOVED***")
